...
// Este endpoint usa o método findAll do Sequelize para buscar todos os usuários cadastrados.
router.get('/', async (req, res) => {
  try {
    const users = await User.findAll();

    if (!users) return res.status(404).json({ message: 'Nem um usuário encontrado' });
